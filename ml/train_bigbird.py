"""
Original starting code from https://github.com/huggingface/transformers/blob/3dae0d7b4fb8d7e9383b893e4e1799191bb2ab7b/examples/flax/text-classification/run_flax_glue.py
Modified to add gradient accumulation and to support the depression classification task
"""
import json
import logging
import math
...
def main():
    ...
    def train_step(
        ...
        def loss_fn(params, minibatch):
            ...
            logits = state.apply_fn(**minibatch, params=params, dropout_rng=dropout_rng, train=True)[0]
